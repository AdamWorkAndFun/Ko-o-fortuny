...
const base={
    kindPassword:['powiedzenie','serial','film'],
...
const addPassword=function(){
    ...
    if(base.kindPassword.length===0){
        base.kindPassword=['powiedzenie','serial','film'];
        base.powiedzenie=['nigdy nie mów nigdy','nosił wilk razy kilka ponieśli i wilka'];
        base.serial=['daleko od noszy','m jak miłośc','noce i dnie','czarne chmury'];
        base.film=['kiler','chłopaki nie płaczą','walka o ogień','harry poter książe tajemnic'];
    }
